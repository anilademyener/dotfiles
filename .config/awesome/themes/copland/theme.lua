...
theme.fg_normal                                 = "#BBBBBB" -- title color
theme.fg_focus                                  = "#FFFFFF" -- title focus color
theme.bg_normal                                 = "#111111" -- background color
theme.bg_focus                                  = "#111111" -- background focus
