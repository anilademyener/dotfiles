...
globalkeys = my_table.join(
    ...
    -- Tag browsing
    --awful.key({ modkey,           }, "Left",   awful.tag.viewprev, -- custom
    --          {description = "view previous", group = "tag"}),
    --awful.key({ modkey,           }, "Right",  awful.tag.viewnext, -- custom
    --          {description = "view next", group = "tag"}),
    awful.key({ modkey,           }, "Escape", awful.tag.history.restore,
              {description = "go back", group = "tag"}),

    awful.key({ modkey,           }, "Left", -- custom
        function ()
            awful.client.focus.byidx( 1)
        end,
        {description = "focus next by index", group = "client"}
    ),
    awful.key({ modkey,           }, "Right", -- custom
        function ()
            awful.client.focus.byidx(-1)
        end,
    ...
    -- Layout manipulation
    --awful.key({ modkey, "Shift"   }, "j", function () awful.client.swap.byidx(  1)    end, -- custom
    --          {description = "swap with next client by index", group = "client"}),
    --awful.key({ modkey, "Shift"   }, "k", function () awful.client.swap.byidx( -1)    end, -- custom
    ...
    --awful.key({ modkey, "Shift" }, "Left", function () lain.util.move_tag(-1) end, -- custom
    --          {description = "move tag to the left", group = "tag"}),
    --awful.key({ modkey, "Shift" }, "Right", function () lain.util.move_tag(1) end, -- custom
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, "Mod"   }, "q",      function (c) c:kill()                         end, -- custom
...
client.connect_signal("request::titlebars", function(c)
    ...
    --[[awful.titlebar(c, {size = dpi(16)}) : setup { -- custom
        { -- Left
